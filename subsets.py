class Solution:
    ...
    #for every previous subset, we add a copy to it and add a[i] to end of copy
    #we get the previous subsets number, use that as our stopping point for adding new subsets
